...
def run():
    wx.GetApp().RunRecordedScript ([
        ...
        (150, wx.MouseEvent, {'eventType':wx.EVT_LEFT_DOWN, 'sentTo':u'AllDayEvents', 'lastWidgetValue':True}, {'m_leftDown':True, 'm_x':329, 'm_y':26}),
        (151, wx.MouseEvent, {'eventType':wx.EVT_LEFT_UP, 'sentTo':u'AllDayEvents'}, {'m_x':329, 'm_y':26}),
        (152, wx.FocusEvent, {'eventType':wx.EVT_SET_FOCUS, 'sentTo':u'AllDayEventsFocusWindow'}, {}),
        (153, wx.MouseEvent, {'eventType':wx.EVT_LEFT_DCLICK, 'sentTo':u'AllDayEvents', 'recordedFocusWindow':u'AllDayEventsFocusWindow', 'recordedFocusWindowClass':wx.Window}, {'m_leftDown':True, 'm_x':329, 'm_y':26}),
        ...
        (175, wx.KeyEvent, {'eventType':wx.EVT_KEY_UP, 'sentTo':u'AllDayEventsFocusWindow'}, {'m_rawCode':13, 'm_keyCode':13, 'm_x':329, 'm_y':26, 'UnicodeKey':13}),
    ])
