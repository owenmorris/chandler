...
class TestOutput:
    ...
    def endSuite(self):
        ...
        self.printOut(u'Ending Suite ""%s"" :: EndTime %s :: Total Time %0.2f seconds' % (self.currentSuite['name'], self.currentSuite['endtime'], _inSeconds(self.currentSuite['totaltime'])), level=3)
    ...
    def endTest(self, comment=None):
        ...
        self.printOut(u'Ending Test ""%s"" :: EndTime %s :: Total Time %0.2f seconds' % (self.currentTest['name'], self.currentTest['endtime'], _inSeconds(self.currentTest['totaltime'])), level=2)
