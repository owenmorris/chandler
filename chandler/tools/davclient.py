...
class DAVClient(object):
    ...
    def __init__(self, url='http://localhost:8080'):
        ...
        self.headers = {'Host':self._url.netloc, 
    ...
    def _request(self, method, path='', body=None, headers=None):
        ...
        if self._url.scheme == 'http':
            self._connection = httplib.HTTPConnection(self._url.netloc)
        elif self._url.scheme == 'https':
            self._connection = httplib.HTTPSConnection(self._url.netloc)
        else:
    ...
    def proppatch(self, path, set_props=None, remove_props=None, properties=None, namespace='DAV:', headers=None):
