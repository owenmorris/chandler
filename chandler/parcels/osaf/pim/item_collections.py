...
class ItemCollection(items.ContentItem, Query.Query):
    ...
    inclusions = schema.Sequence(
        items.ContentItem,
        inverse=items.ContentItem.itemCollectionInclusions,
        initialValue=(),
    )

    exclusions = schema.Sequence(
        items.ContentItem,
        inverse=items.ContentItem.itemCollectionExclusions,
        initialValue=(),
    )
    ...
    schema.addClouds(
        copying = schema.Cloud(
            ...
            byCloud=[
                ...
                items.ContentItem.contentsOwner
            ]
        ),
