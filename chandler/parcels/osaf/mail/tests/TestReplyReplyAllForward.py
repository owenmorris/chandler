...
--===============0474779284==--"""
    ...
    def tearDown(self):
        ...
        self.view.tzinfo.setDefault(self.savedTzinfo)
    ...
    def testEventReplyLogic(self):
        ...
        self.assertTrue(u"demo3@test.com wrote on Oct 5, 2006 at 10:11 AM:" in newMessage.body)
    ...
    def testReplyBody(self):
        newMessage = MailStamp(replyToMessage(self.view, self.messageOne))
        self.assertTrue(u"bill@home.net wrote on Aug 9, 2004 at 10:55 AM:" in newMessage.body)
    ...
    def testForward(self):
        ...
        self.assertTrue(fwdBody in newMessage.body)
