...
UPLOAD_NO_REPLY_ADDRESS = _("Unable to obtain a Reply-To Address for Account %s")
UPLOAD_BAD_REPLY_ADDRESS = _("The Reply-To Address %s for Account %s is not valid")
