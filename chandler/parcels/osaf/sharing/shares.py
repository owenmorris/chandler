...
class Share(pim.ContentItem):
    ...
    def sync(self, modeOverride=None, updateCallback=None):
        ...
        return sync(self.getLinkedShares(), modeOverride=modeOverride,
            updateCallback=updateCallback)

    def put(self, updateCallback=None):
        from synchronize import sync
        return sync(self.getLinkedShares(), modeOverride='put',
             updateCallback=updateCallback)

    def get(self, updateCallback=None):
        from synchronize import sync
        return sync(self.getLinkedShares(), modeOverride='get',
             updateCallback=updateCallback)
