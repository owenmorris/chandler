        ...
        childrenBlocks = [
            ...
            Menu.template('ViewMenu',
                ...
                childrenBlocks = [
                    ...
                    MenuItem.template('ViewSeparator',
                        menuItemKind = 'Separator'),
            ...
            Menu.template('TestMenu',
                ...
                childrenBlocks = [
                    ...
                    MenuItem.template('TestSep3', menuItemKind='Separator'),
                    ...
                    MenuItem.template('TestSep4', menuItemKind='Separator'),
                    ...
                    MenuItem.template('TestSep1', menuItemKind='Separator'),
                    ...
                    Menu.template('AddAdditionalViews',
                        ...
                        childrenBlocks = [
                            ...
                            MenuItem.template('TestViewSeparator',
                                menuItemKind = 'Separator'),
                    ...
                    MenuItem.template('TestSep2', menuItemKind='Separator'),
