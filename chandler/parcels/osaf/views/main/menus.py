...
def makeMainMenus(parcel):
        ...
        childBlocks = [
            ...
            Menu.template('ShareMenu',
                ...
                childBlocks = [
                    ...
                    MenuItem.template('UnshareCollectionItem',
                        event = main.UnshareCollection,
                        title = _(u'Stop sharing'),
    ...
    Menu.template('ItemContextMenu',
                title = _(u'Item'),
                childBlocks = [
                    Menu.template('ItemnContextNewItemMenu',
                        title = _(u'&New item'),
                        helpString = _(u'Create a new Content Item'),
                        childBlocks = [
                            MenuItem.template('ItemnContextNewNoteItem',
                                event = main.NewNote,
                                title = _(u'New &note'),
                                accel = _(u'Shift+N'),
                                helpString = _(u'Create a new Note')),
                            MenuItem.template('ItemnContextNewMessageItem',
                                event = main.NewMailMessage,
                                title = _(u'New &message'),
                                accel = _(u'Shift+M'),
                                helpString = _(u'Create a new Message')),
                            MenuItem.template('ItemnContextNewTaskItem',
                                event = main.NewTask,
                                title = _(u'New &task'),
                                accel = _(u'Shift+T'),
                                helpString = _(u'Create a new Task')),
                            MenuItem.template('ItemnContextNewEventItem',
                                event = main.NewCalendar,
                                title = _(u'New &event'),
                                accel = _(u'Shift+E'),
                                helpString = _(u'Create a new Event')),
                            ]),
                    MenuItem.template('ItemnContextCutItem',
                        event = globalBlocks.Cut,
                        title = messages.CUT),
                    MenuItem.template('ItemnContextCopyItem',
                        event = globalBlocks.Copy,
                        title = messages.COPY),
                    MenuItem.template('ItemnContextDuplicateItem',
                        event = globalBlocks.Duplicate,
                        title = _(u'Duplicate'),
                        helpString = _(u'Duplicate the selected collection')),
                    MenuItem.template('ItemnContextPasteItem',
                        event = globalBlocks.Paste,
                        title = messages.PASTE),
                    MenuItem.template('RemoveItem',
                        event = globalBlocks.Remove,
