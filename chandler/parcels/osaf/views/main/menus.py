    ...
    fileMenu =  Menu.template('FileMenu',
                ...
                childBlocks = [
                    MenuItem.template('ImportIcalendarItem',
                        ...
                        title = _(u'&Import .ics calendar file...'),
                        helpString = _(u'Import iCalendar file')),
                    MenuItem.template('ExportIcalendarItem',
                        event = main.ExportIcalendar,
                        title = _(u'&Export .ics calendar file...'),
                        helpString = _(u'Export Tasks and Calendar Events to an iCalendar file')),
                    ...
                    MenuItem.template('DumpToFileItem',
                        ...
                        helpString = _(u'Export items to file')),
                    ...
                    Menu.template('ViewAsCalendarMenu',
                        ...
                        childBlocks = [
                            MenuItem.template('ViewAsCalendarIteminWeekView',
                                ...
                                title = _(u'&Week View'),
                                menuItemKind = 'Check',
                                helpString = _(u'Display data in a Calendar week view')),
                            MenuItem.template('ViewAsCalendarIteminDayView',
                                event = main.ViewAsDayCalendar,
                                title = _(u'&Day View'),
                                menuItemKind = 'Check',
                                helpString = _(u'Display data in a Calendar day view'))
                        ]),
                ...
                childBlocks = [
                    ...
                    Menu.template('SaveRestoreMenu',
                        ...
                        childBlocks = [
                            ...
                            MenuItem.template('ObfuscatedDumpToFileItem',
                                ...
                                title = _(u'&Obfuscated dump to file...'),
                                helpString = _(u'Dump items with personal data scrambled')),
                    ...
                    Menu.template('ShareTestMenu',
                        ...
                        childBlocks = [
                            ...
                            MenuItem.template("CalDAVAtopEIMItem",
                                ...
                                title = u"Enable CalDA&V-atop-EIM",
                            ...
                            MenuItem.template("InmemoryPublishItem",
                                event = main.InmemoryPublish,
                                title = u"&Publish In-memory",
                                helpString = u'Publish a collection in-memory'),
                    ...
                    Menu.template('DebugMenu',
                        ...
                        childBlocks = [
                            ...
                            MenuItem.template('ShowWidgetInspectorItem',
                                event = main.ShowWidgetInspector,
                                title = u'Show widget &inspection tool...',
                                helpString = u'Displays the widget inspection tool, showing all current widgets and sizers'),
