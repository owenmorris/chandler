...
import sys
sys.path.append('c:\osaf\osaf\chandler\Chandler\parcels')
...
class SimpleTest(unittest.TestCase):
	...
	"""
        ...
        self.rep.loadPack('c:/osaf/osaf/chandler/Chandler/model/packs/schema.pack')
        self.rep.loadPack('c:/osaf/osaf/chandler/Chandler/parcels/OSAF/calendar/model/calendar.pack')
