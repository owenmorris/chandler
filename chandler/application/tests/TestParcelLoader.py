...
class SimpleParcelLoaderTestCase(ParcelLoaderTestCase.ParcelLoaderTestCase):
    ...
    def testLoadParcels(self):
        ...
        simpleParcel = view.findPath("//parcels/application/tests/testparcels/simple")
        self.assertEqual(simpleParcel.itsKind, Parcel.getKind(view))
        ...
        testAttribute = view.findPath("//parcels/application/tests/testparcels/simple/TestAttribute")
        self.assertEqual(testAttribute.itsKind,
         view.findPath('//Schema/Core/Attribute'))
        self.assertEqual(testAttribute.type, 
         view.findPath('//Schema/Core/String'))
        ...
        testKind = view.findPath("//parcels/application/tests/testparcels/simple/TestKind")
        ...
        subKind = view.findPath("//parcels/application/tests/testparcels/simple/SubKind")
        ...
        # sets properly
        # item1 = view.findPath("//parcels/application/tests/testparcels/simple/data/item1")

        # Ensure that initialValue for a list/dict attributes are
        # set properly
        item3 = view.findPath("//parcels/application/tests/testparcels/simple/data/item3")
