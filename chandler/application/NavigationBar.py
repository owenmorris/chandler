...
class NavigationBar(wxToolBar):
    def __init__(self):
        ...
        EVT_TOOL(self, XRCID("prev"), self.__GoPrev)
        EVT_TOOL(self, XRCID("next"), self.__GoNext)
        EVT_TOOL(self, XRCID("stop"), self.__DoStop)
        EVT_TOOL(self, XRCID("reload"), self.__DoReload)
        EVT_TOOL(self, XRCID("home"), self.__GoHome)
        EVT_TEXT_ENTER(self, XRCID("uriBox"), self.__GoToUri)
