This plugin provides support for Twitter in Chandler.
...
InstallPlugin script and restart Chandler::
    ...
    InstallPlugin Chandler-TwitterPlugin
...
The svn sources for this plugin are at:
 ...
 http://svn.osafoundation.org/chandler/trunk/chandler/projects/Chandler-TwitterPlugin#egg=Chandler_TwitterPlugin-dev

and can be retrieved with::

    RunPython -m easy_install --editable -b . Chandler_TwitterPlugin==dev
