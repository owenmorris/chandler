This plugin provides support for implementing a file system in python using the 
FUSE (or MacFUSE) library. This plugin requires FUSE on Linux, MacFUSE on
Mac and is not supported on Windows.
