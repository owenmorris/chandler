...
To download and install the plugin, use Chandler's InstallPlugin script::
    ...
    InstallPlugin Chandler-EVDBPlugin
...
The svn sources for this plugin are at:
 ...
 http://svn.osafoundation.org/chandler/trunk/chandler/projects/Chandler-EVDBPlugin#egg=Chandler_EVDBPlugin-dev

and can be retrieved with::

    RunPython -m easy_install --editable -b . Chandler_EVDBPlugin==dev
