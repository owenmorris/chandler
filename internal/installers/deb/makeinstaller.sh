...
if [ -d "$DEB_PATH" ]; then
    ...
    echo "Moving ${DEB_PATH}/chandler_${DISTRIB_VERSION}.${DISTRIB_RELEASE}-1_i386.deb to ${DISTRIB_PATH}/${DISTRIB_FILE}_i386.deb"
    mv ${DEB_PATH}/chandler_${DISTRIB_VERSION}.${DISTRIB_RELEASE}-1_i386.deb ${DISTRIB_PATH}/${DISTRIB_FILE}_i386.deb
