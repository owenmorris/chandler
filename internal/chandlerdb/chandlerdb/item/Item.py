...
from chandlerdb.item.RefCollections import RefList, RefDict
...
class Item(CItem):
    ...
    def getValue(self, attribute, key=None, alias=None,
        ...
        is a L{ref collection<chandlerdb.item.RefCollections.RefList>}.
    ...
    def setValue(self, attribute, value, key=None, alias=None, otherKey=None,
        ...
        collection is a
        L{ref collection<chandlerdb.item.RefCollections.RefList>}. 
        @type key: integer for lists, anything for dictionaries
        @param alias: when the collection is a
        L{ref collection<chandlerdb.item.RefCollections.RefList>}, C{alias}
    ...
    def addValue(self, attribute, value, key=None, alias=None, otherKey=None,
        ...
        L{ref collections<chandlerdb.item.RefCollections.RefList>}
        @type key: anything
        @param alias: when the collection is a
        L{ref collection<chandlerdb.item.RefCollections.RefList>}, C{alias}
        may be used to specify an alias for the reference to insert into the
    ...
    def copy(self, name=None, parent=None, copies=None,
        ...
        L{Cloud<chandlerdb.schema.Cloud.Cloud>} instance to drive the copy
    ...
    def delete(self, recursive=False, deletePolicy=None, cloudAlias=None,
        ...
        L{Cloud<chandlerdb.schema.Cloud.Cloud>} instance to drive the delete
        operation by using the C{cloudAlias} argument.
    ...
    def _deferDelete(self, view, deletePolicy):
        ...
        if not self.isSchema():
            for name, value in refs.items():
                if value is not None:
                    if value._isRefs():
                        if name not in ('watches', 'monitors', 'watchers'):
                            value.clear()
                    else:
    ...
    def setACL(self, acl, name=None):
        ...
        @param acl: an L{ACL<chandlerdb.item.Access.ACL>} instance
    ...
    def getACL(self, name=None, default=Default):
        ...
        @type name: a string
        @return: an L{ACL<chandlerdb.item.Access.ACL>} instance or C{None} if
        no ACL is set
    ...
    def find(self, spec, load=True, attribute=None):
        ...
        @type spec: L{Path<chandlerdb.util.Path.Path>} or
