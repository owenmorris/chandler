...
void wxToolBar::OnPaint(wxPaintEvent& event)
{
    ...
    // OSAF: (21-Oct-05)
    // this has the visual result of a frame (outline) border;
    // Chandler's mark-up bar is specified as being non-bordered,
    // so it's NOPped out here for the time being...
