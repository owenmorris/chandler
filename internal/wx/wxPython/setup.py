...
#
# Created:     12-Oct-2000
# RCS-ID:      $Id: setup.py,v 1.157 2006/02/06 03:03:24 KO Exp $
...
swig_sources = run_swig(['minical.i'], 'src', GENDIR, PKGDIR,
                        USE_SWIG, swig_force, swig_args, swig_deps)
ext = Extension('_minical', swig_sources,
                include_dirs =  includes,
                define_macros = defines,
                library_dirs = libdirs,
                libraries = libs,
...
swig_sources = run_swig(['colheader.i'], 'src', GENDIR, PKGDIR,
                        USE_SWIG, swig_force, swig_args, swig_deps)
ext = Extension('_colheader', swig_sources,
                include_dirs =  includes,
                define_macros = defines,
                library_dirs = libdirs,
                libraries = libs,
